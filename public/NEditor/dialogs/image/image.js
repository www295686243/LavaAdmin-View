...
(function () {
    ...
    window.onload = function () {
        ...
        initAlign();
        initButtons();
        $("#setImageAuto").on('click', 'button', function () {
            $("#width").val($(this).data('value'))
            $("#height").val('')
        })
    };
        ...
        getInsertList: function () {
            ...
            if(data['url']) {
                return [{
                    ...
                    vspace: data['vhSpace'] || '',
                    alt: data['title'] || '',
                    style: data['width'].indexOf('%') > -1 ? "width: " + data['width'] + ";height: auto" : "width:" + data['width'] + "px;height:" + data['height'] + "px;"
                }];
            } else {
                return [];
            }
