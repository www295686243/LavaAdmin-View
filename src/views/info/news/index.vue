<template>
  <PageContainer>
    <TableRender :Service="Service">
      ...
      <TableOptions prop="select" label="select" :colors="{ 1: 'success', 2: 'error' }" :options="[]" :props="{ label: 'label', value: 'value' }"></TableOptions>
      <TableOptions prop="radio" label="radio" :colors="{ 1: 'success', 2: 'error' }" :options="[]" :props="{ label: 'label', value: 'value' }"></TableOptions>
      ...
      <TableCheckbox prop="checkbox" label="checkbox" :options="[]" :props="{ label: 'label', value: 'value' }"></TableCheckbox>
